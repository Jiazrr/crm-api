...
public class LeadController {
    ...
    @Log(title = "线索管理-分页查询", businessType = BusinessType.SELECT)
    ...
    @Log(title = "线索管理-新增/修改线索", businessType = BusinessType.INSERT_OR_UPDATE)
    ...
    @Log(title = "线索管理-跟进线索", businessType = BusinessType.OTHER)
    ...
    @Log(title = "线索管理-线索转客户", businessType = BusinessType.OTHER)
